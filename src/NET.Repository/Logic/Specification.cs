...
namespace GenericRepository.Logic {
    /// <summary>
    /// <para>Specification Pattern Implementation</para>
    /// <para>Author: Vladimir Khorikov</para>
    /// <para>Source: https://github.com/vkhorikov/SpecificationPattern</para>
    /// </summary>
    ...
    public abstract class Specification<T> {
        ...
        public bool IsSatisfiedBy(T entity) {
            Func<T, bool> predicate = ToPredicate();
    ...
    public sealed class AbsoluteTrueSpecification<T> : Specification<T> {
        public override Expression<Func<T, bool>> ToExpression() => param => true;
    }

    public sealed class AbsoluteFalseSpecification<T> : Specification<T> {
        public override Expression<Func<T, bool>> ToExpression() => param => false;
    }
